...
/**
 * 实际上并不是module，因为信息是静态的，只需要在其所属的module初始化时实例化就可以了
...
final public class Entrance extends HashMap<Building, Set<Road>> {
	...
	public Entrance(WorldInfo wi) {
		this.allEntrance = new HashSet<Road>();
		for (StandardEntity entity : WorldTools.getEntitiesOfType(AgentConstants.BUILDINGS, wi)) {
			Building building = (Building) entity;
			Set<Road> entrances = setEntrance(building, wi);
	 ...
	 */
	private Set<Road> setEntrance(Building building, WorldInfo wi) {
