...
public class NUDTDecentralizedPoliceTargetAllocator extends PoliceTargetAllocator
{
    public NUDTDecentralizedPoliceTargetAllocator(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData)
    {
