...
public class NUDTDecentralizedAmbulanceTargetAllocator extends AmbulanceTargetAllocator
{
    public NUDTDecentralizedAmbulanceTargetAllocator(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData)
    {
