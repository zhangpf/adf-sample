...
public class NUDTDecentralizedFireTargetAllocator extends FireTargetAllocator
{
    public NUDTDecentralizedFireTargetAllocator(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData)
    {
