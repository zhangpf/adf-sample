...
//		return preScaledPolygon;
	 ...
	 * 
	 * 将凸包放大（2 - scale）倍得到bigBorderPolygon
	 * 将凸包缩小scale倍得到smallBorderPolygon
	 * 如果一个建筑有某个点在bigBorderPolygon与smallBorderPolygon之间，
	 * 就认为这个建筑在凸包的边界
	 * 
	...
	public static Set<StandardEntity> getMapBorderBuildings(CompositeConvexHull convexHull, 
			Set<StandardEntity> entities, double scale, StandardWorldModel world) {
		Building building;
